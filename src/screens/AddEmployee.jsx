...
export default function AddEmployee() {
    ...
    async function handleSubmit(e) {
        e.preventDefault();
        const responseid = await fetch("https://employee-management-8ttewlwzf-keshavtomar.vercel.app/api/getId", {
            method: 'POST',
            headers: {
        ...
        const response = await fetch("https://employee-management-8ttewlwzf-keshavtomar.vercel.app/api/addEmployee", {
            method: 'POST',
            headers: {
                'Content-type': 'application/json'
            },
